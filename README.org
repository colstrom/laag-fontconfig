#+TITLE: Library as a Gem - fontconfig
#+LATEX: \pagebreak

* Overview

  ~laag-fontconfig~ packages [[https://www.freedesktop.org/wiki/Software/fontconfig/][fontconfig]] as a Ruby Gem, using [[https://github.com/colstrom/laag][laag]].
...
* Updating this Package
  ...
  #+BEGIN_SRC shell
    git-vendor update fontconfig 2.13.0
  #+END_SRC
