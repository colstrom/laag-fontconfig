...
Gem::Specification.new do |spec|
  ...
  spec.name          = "laag-fontconfig"
  spec.version       = "#{tag}.#{commits}"
  spec.authors       = ["Chris Olstrom"]
  spec.email         = ["chris@olstrom.com"]
  spec.summary       = "Library as a Gem - fontconfig"
  spec.homepage      = "https://github.com/colstrom/laag-fontconfig"
  spec.licenses      = ['MIT']
  spec.files         = `git ls-files -z`.split("\x0")
  spec.require_paths = ["lib"]
  spec.extensions    = ["ext/laag/fontconfig/extconf.rb"]
